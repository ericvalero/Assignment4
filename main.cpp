//--------------------------------------------------------------------------
//Program: Valero-Barron-Assn4-pro
//Class: Advanced programming and algorithms
//Developers: Eric Valero and Jose Barron
//Description: Chooses two of four sorting methods to use, tracks results and
//				displays average sort time
//--------------------------------------------------------------------------
#include <iostream>			//standard i/o
#include <ctime>			//use of time library functions
#include <cstdlib>			//std library
#include <string>			//use of strings
#include <cmath>			//use of advanced mathematical functions
